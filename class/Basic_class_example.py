...
if __name__ == "__main__":
    ...
    print(f"Use '.' for class variable: MyClass.StaticVar={MyClass.StaticVar}")
    print(f"Also use '.' for instance variable: obj.StaticVar={obj.StaticVar}")
    print(f"Different instances have the same StaticVar: obj.StaticVar=obj1.StaticVar={obj1.StaticVar}")
    print(f"c={obj.c}")
    print(f"d={obj.d}")
    obj.func_inside()
    print(obj.func_outside())
    print(f"Testing of attribute decorator : obj.StaticConstVariable={obj.StaticConstVariable}")
